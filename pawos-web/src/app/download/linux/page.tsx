      ...
      <div className="mx-auto mt-10 max-w-md space-y-4">
        {platform.variants.map((v) => (
          <div key={v.id} className="flex items-center justify-between rounded-lg border border-neutral-800 p-4">
            ...
            <NotifyButton platform="linux" className="rounded-full border border-blue-400/40 px-4 py-1.5 text-xs font-semibold text-blue-200 hover:border-blue-300 hover:text-blue-100" />
          </div>
        ))}
      </div>
    </Section>

...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Autonomous Engineering Tasks now run on a prepaid Ticket Balance (any amount, $30 minimum) rather than a monthly allowance, billed per ticket at a volume-tiered rate — $5.00 down to $3.00 depending on cumulative ticket count — instead of a flat per-credit price. Balance never expires, and balance, purchase history, and usage history are all visible in-app with full CSV export.",
    ],
  },
  {
    slug: "case-studies",

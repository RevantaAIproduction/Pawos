...
export const RUNTIMES: RuntimeDoc[] = [
  ...
  },
  {
    ...
    purpose: "Provider-aware deployment and production investigation for already-supported local connectors.",
    capabilities: [
      "Deploy, roll back, and promote through the currently implemented connector surface",
      "Investigate configured providers without adding SSH, Docker, CI/CD, or cloud execution adapters in this phase",

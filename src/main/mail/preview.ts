...
const TEMPLATES: Record<string, TemplateEntry> = {
  welcome: { label: 'Welcome', build: (b) => React.createElement(Welcome, { name: 'Alex', launchUrl: 'https://pawos.revantaai.com', ...b }) },
  otp: { label: 'OTP Code', build: (b) => React.createElement(OTP, { code: '482913', expiresInMinutes: 5, ...b }) },
  verifyEmail: {
    label: 'Verify Email',
    build: (b) => React.createElement(VerifyEmail, { name: 'Alex', verifyUrl: 'https://pawos.revantaai.com/verify?token=demo', ...b }),
  },
  passwordReset: {
    label: 'Password Reset',
    build: (b) => React.createElement(PasswordReset, { name: 'Alex', resetUrl: 'https://pawos.revantaai.com/reset?token=demo', ...b }),
  },
  ...
  subscriptionTrialStarted: {
    ...
    build: (b) =>
      React.createElement(SubscriptionEvent, {
        ...
        manageUrl: 'https://pawos.revantaai.com/account/subscription',
        ...b,
      }),
  },
  ...
  paymentSuccess: {
    ...
    build: (b) => React.createElement(PaymentSuccess, { name: 'Alex', amount: '$12.00', planName: 'Pro', invoiceUrl: 'https://pawos.revantaai.com/invoices/demo', ...b }),
  },
  paymentFailed: {
    label: 'Payment Failed',
    build: (b) =>
      React.createElement(PaymentFailed, { name: 'Alex', amount: '$12.00', planName: 'Pro', updatePaymentUrl: 'https://pawos.revantaai.com/account/billing', ...b }),
  },
  invoice: {
    label: 'Invoice',
    build: (b) =>
      React.createElement(Invoice, {
        ...
        downloadUrl: 'https://pawos.revantaai.com/invoices/demo.pdf',
        ...b,
      }),
  },
  ...
  companionCreated: {
    ...
    build: (b) => React.createElement(CompanionCreated, { name: 'Alex', companionName: 'Nova', openUrl: 'https://pawos.revantaai.com', ...b }),
  },
  companionUpdated: {
  ...
  productUpdate: {
    ...
    build: (b) =>
      React.createElement(ProductUpdate, {
        ...
        learnMoreUrl: 'https://pawos.revantaai.com/changelog',
        ...b,
      }),
  },
  productNewFeature: {
  ...
  newsletter: {
    ...
    build: (b) =>
      React.createElement(Newsletter, {
        ...
        ctaUrl: 'https://pawos.revantaai.com/changelog',
        unsubscribeUrl: 'https://pawos.revantaai.com/unsubscribe?demo=1',
        ...b,
      }),
  },
};

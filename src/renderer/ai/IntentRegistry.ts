...
export const ACTION_TOOL_DEFINITIONS: ReasoningToolDefinition[] = [
  ...
  },
  {
    ...
    parameters: {
      type: 'object',
      properties: {
        organizationId: { type: 'string', description: "The organization this task belongs to, if the user is working within a Team/Enterprise organization. Omit entirely for an individual Pro/Pro Max account with no organization — it's billed against that account's own Ticket Balance instead." },

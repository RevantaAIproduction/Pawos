      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, padding: '8px 0' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {usageMenuOpen && (
            ...
            >
              <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(var(--pawos-overlay-rgb), 0.6)', marginBottom: 8 }}>
              ...
              {entitlement?.limit5hPc && (
                <div style={{ fontSize: 11, color: 'rgba(var(--pawos-overlay-rgb), 0.8)', marginBottom: 8 }}>
                  <div style={{ marginBottom: 4 }}>5-hour limit</div>
              ...
              {entitlement?.activeHoursWeekly !== null && entitlement?.activeHoursWeekly > 0 && (
                <div style={{ fontSize: 11, color: 'rgba(var(--pawos-overlay-rgb), 0.8)' }}>
                  <div style={{ marginBottom: 4 }}>Weekly · all models</div>
                  <div>{(() => {
